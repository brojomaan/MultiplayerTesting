...
public class DiscardVisual : MonoBehaviour
{
    private static readonly int Alpha = Shader.PropertyToID("_Alpha");

    [Header("Transforms")] 
    [SerializeField] private RectTransform rootRect;
    [SerializeField] private RectTransform discard;
    ...
    public void ShakeDeck()
    {
        ...
        discard.DOShakePosition(0.3f, 10f).SetEase(Ease.InOutQuad);
    }
    ...
    public void ResetPosition()
    {
        ...
        discard.transform.DOLocalMove(Vector3.zero, 0.3f).SetEase(Ease.InOutQuad);
    }
}
